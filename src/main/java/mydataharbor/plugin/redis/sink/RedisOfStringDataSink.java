 ...
 **/
@Slf4j
public class RedisOfStringDataSink extends AbstractRedisDataSink<RedisOfStringDataSinkReq, BaseSettingContext> {

  public RedisOfStringDataSink(RedisDataSinkConfig redisDataSinkConfig) {
    super(redisDataSinkConfig);
  }

  @Override
  public WriterResult write(RedisOfStringDataSinkReq record, BaseSettingContext settingContext) throws ResetException {
    try {
  ...
  @Override
  public WriterResult write(List<RedisOfStringDataSinkReq> records, BaseSettingContext settingContext) throws ResetException {
    try {
      Map<String, String> map = records.parallelStream().collect(Collectors.toMap(RedisOfStringDataSinkReq::getKey, RedisOfStringDataSinkReq::getValue, (key1, key2) -> key2));
